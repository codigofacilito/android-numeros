...
public class Utilities {
    ...
    public static Point geTamañoPantalla(Context context) {
    ...
    public static Point getResolucionCamara(Context context, Camera camera) {
        return findBestPreviewSizeValue(camera.getParameters(), geTamañoPantalla(context));
    }
